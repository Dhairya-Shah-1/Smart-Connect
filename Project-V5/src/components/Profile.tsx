...
import { User, LogOut, Mail, MapPin as MapPinIcon } from 'lucide-react';
        ...
        {(user.role === 'admin' || user.role === 'super_admin') && (
          <div className="grid grid-cols-2 gap-4">
            <div className={`rounded-xl shadow-md border p-6 ${
              ...
              <div className={`text-3xl mb-2 ${isDark ? 'text-purple-400' : 'text-purple-600'}`}>
                {reportsChecked}
              </div>
              <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                Reports Checked
            ...
            <div className={`flex items-center gap-3 p-3 rounded-lg ${
              ...
              <div>
                ...
                <div className={`text-sm ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>
                  {getRoleDisplay()}{departmentName && ` - ${departmentName}`}
                </div>
              </div>
            </div>
          </div>
