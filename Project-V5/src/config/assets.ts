...
export const ASSETS = {
  ...
  Lightning: 'https://sbbfbzytpshfnlhymkss.supabase.co/storage/v1/object/public/app-assets/Lightning_(Image_by_starline_on_freepik)_2_(without-bg).png',

  People: 'https://sbbfbzytpshfnlhymkss.supabase.co/storage/v1/object/public/app-assets/People(Gemini)(without-bg).png',
